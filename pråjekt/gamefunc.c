...
/* Declare a he1lper function which is local to this file */
...
void lose_screen(){
  display_string(0, "Mommy caught you!");
  display_string(1, " You picked up  ");

  display_string(2, "          ");
  display_string(2, itoaconv(score));
  display_string(3, "    children     ");
  display_update();
